            ...
            <form className={styles.form} onSubmit={handleSubmit(onSubmit)}>
                <section className='formSection'>
                    ...
                    <h3>Endereço</h3>
                        <div>
                            ...
                            <input id='CEP' type='number' {...register("endereco.cep", {required: true})} /> 
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input id='numero' type='number' {...register("endereco.numero", {required: true})} /> 
                        </div>
                        <div>
                ...
                <section className='formSection'>
                    ...
                    <div>
                        ...
                        <input type='number' placeholder='(99) 99999-9999' id='fonePai' {...register("pai.fone")} /> 
                    </div>
                    <div>
                ...
                <h2>Informações da mãe:</h2>
                    ...
                    <div>
                        ...
                        <input type='number' placeholder='(99) 99999-9999' id='foneMae' {...register("mae.fone")} /> 
                    </div>
                    <div>
                ...
                <section className="formSection">
                    ...
                    <div>
                        ...
                        <input id='RGresponsavel' type='number' {...register("responsavel.rg", {required: true})} /> 
                    </div>
                    <div>
                        <label htmlFor="CPFresponsavel">CPF:</label>
                        <input id='CPFresponsavel' type='number' {...register("responsavel.cpf", {required: true})} /> 
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input id='foneTrabalhoResponsavel' type='number' placeholder='(99) 99999-9999' {...register("responsavel.fone_trabalho")} /> 
                    </div>
                    <div>
                        <label htmlFor="foneResponsavel">Fone pessoal:</label>
                        <input id='foneResponsavel' type='number' placeholder='(99) 99999-9999' {...register("responsavel.fone_pessoal")} /> 
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input id='CEPenderecoResponsavel' type='number' {...register("responsavel.endereco.cep", {required: true})} /> 
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input id='numeroEnderecoResponsavel' type='number' {...register("responsavel.endereco.numero", {required: true})} /> 
                    </div>
                    <div>
                ...
                <section className="formSection">
                    ...
                    <div>
                        ...
                        <input type='number' placeholder='(99) 99999-9999' id='foneEmergencia' {...register("emergencia.fone")} /> 
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input id="rgAutorizado" type='number' {...register('rgAutorizado1')} />
                    </div>
                    <div>
                        <label htmlFor="foneAutorizado">Fone do autorizado:</label>
                        <input id="foneAutorizado" type='number' placeholder='(99) 99999-9999' {...register('foneAutorizado1')} />
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input id="rgAutorizado2" type='number' {...register('rgAutorizado2')} />
                    </div>
                    <div>
                        <label htmlFor="foneAutorizado2">Fone do autorizado 2:</label>
                        <input id="foneAutorizado2" type='number' placeholder='(99) 99999-9999' {...register('foneAutorizado2')} />
                    </div>
                </section>
